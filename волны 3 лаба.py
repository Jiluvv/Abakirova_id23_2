...
pausa = False
rabota = True
vremja = 0  # Время для анимации
vremja_nachala = 0  # Время запуска анимации
vremja_pauzi = 0  # Сохранённое время на момент паузы
...
def otkryt_nastroyki(index, yvo_volna):
    """Открывает окно для изменения параметров волны или поплавка в отдельном потоке."""
